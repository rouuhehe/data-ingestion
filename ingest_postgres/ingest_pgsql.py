...
s3.upload_file(ficheroUpload3, S3_BUCKET, f'proyecto-parcial/postgres/{ficheroUpload3}')
print("vaccines table was exported to S3")
s3.upload_file(ficheroUpload4, S3_BUCKET, f'proyecto-parcial/postgres/{ficheroUpload4}')
